...
plt.figure(figsize=(14, 7))
plt.hist(df['Predicted Price'], bins=30, density=True, alpha=0.6, color='blue', label='Empirical Distribution')  # Creates histogram with bars
...
plt.plot(x, p, 'k', linewidth=2, label='Normal Distribution (PDF)')  # Overlay PDF as a line
